...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) {
        // Kiểm tra xem userDAO có tồn tại trong database không?
...
import me.loda.springsecurityhibernatejwt.userDAO.CustomUserDetails;
...
public class JwtTokenProvider {
    ...
    // Tạo ra jwt từ thông tin userDAO
    public String generateToken(CustomUserDetails userDetails) {
        Date now = new Date();
        Date expiryDate = new Date(now.getTime() + JWT_EXPIRATION);
        // Tạo chuỗi json web token từ id của userDAO.
        return Jwts.builder()
...
import me.loda.springsecurityhibernatejwt.userDAO.UserService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            log.error("failed on set userDAO authentication", ex);
        }
...
public class App implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Insert vào csdl một userDAO.
        User userDAO = new User();
        userDAO.setUsername("loda");
        userDAO.setPassword(passwordEncoder.encode("loda"));
